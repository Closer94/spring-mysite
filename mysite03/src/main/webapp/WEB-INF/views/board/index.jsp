					...
					<c:forEach items="${list }" var="vo" varStatus="status">
						<tr>
							...
							<c:if test="${vo.writerId == authUser.name }">
								<td>
									<a href="${pageContext.request.contextPath }/board?a=deleteform&regDate=${vo.regDate }" class="del" style="background-images: url('${pageContext.request.contextPath }/assets/images/recycle.png')">삭제</a>
								</td>
							</c:if>
						</tr>
